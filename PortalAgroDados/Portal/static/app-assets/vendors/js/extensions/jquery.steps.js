...
! function(a, b) {
    ...
    function E(b, c, d, e) {
        ...
        if (null != e) {
            var i = j(b, e);
            i.parent().addClass("done").removeClass("error")._selectAria(!1), h.eq(e).removeClass("current step-active").next(".body").removeClass("current"), g = i.find(".current-info"), f.focus()
        }
        f.prepend(g).parent()._selectAria().removeClass("done")._enableAria(), h.eq(d.currentIndex).addClass("current step-active").next(".body").addClass("current")
    }
    ...
    if(typeof habilitarAbas === "undefined")
        habilitarAbas = 0;
    if(typeof stepInicial === "undefined")
        stepInicial = 0;
    var $ = a.fn.steps.contentMode = {
        ...
        cb = a.fn.steps.defaults = {
            ...
            autoFocus: !1,
            enableAllSteps: !habilitarAbas, //habilitar todos os campos var habilitarAbas 0 = on | 1 = off
            ...
            forceMoveForward: !1,
            saveState: !1,
            startIndex: stepInicial, //index de inicialização var stepInicial
