(function(g) {
    ...
    s.ext.buttons.copyHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            if (i.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    b.buttons.info(b.i18n("buttons.copyTitle",
                        "Copiar para área de transferência"), b.i18n("buttons.copySuccess", {
                        1: "Copiou uma linha para a área de transferência",
                        _: "Copiou %d linha para a área de transferência"
                    }, a.rows), 2E3);
                    return
                } catch (f) {}
            }
            ...
            b.buttons.info(b.i18n("buttons.copyTitle", "Copiar para área de transferência"), a, 0);
            c[0].focus();
            c[0].select();
